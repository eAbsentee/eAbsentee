...
with SSHClient() as ssh:
    ...
    count_stdin, count_stdout, count_stderr = ssh.exec_command(f"mysql -u {username} -h {username}.mysql.pythonanywhere-services.com -e 'SELECT COUNT(*) FROM users' '{username}$users'")
